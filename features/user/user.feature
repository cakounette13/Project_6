Feature: User
  ...
  Background: Logging
    ...
    And I fill in "Nom d'utilisateur" with "emoen"
  ...
  Scenario: Add a new observation
    ...
    And I attach the file "D:/wamp64/www/Project_6/web/images/peacock.jpg" to "birds[image]"
    And I press "Envoyer"
